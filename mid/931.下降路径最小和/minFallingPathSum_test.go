...
func Test_minFallingPathSum(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "[2,1,3],[6,5,4],[7,8,9]",
			args: args{[][]int{{2, 1, 3}, {6, 5, 4}, {7, 8, 9}}},
			want: 13,
		},
		{
			name: "[[63,70,79,18],[90,16,-10,32],[100,84,59,-84],[23,-3,26,69]]",
			args: args{matrix: [][]int{{63, 70, 79, 18}, {90, 16, -10, 32}, {100, 84, 59, -84}, {23, -3, 26, 69}}},
			want: -50,
		},
		{
			name: "[[-17,-2,73,44,35,-70],[98,-18,22,-23,-91,-6],[-70,-94,24,26,-79,10],[-31,-23,56,-2,77,22],[-7,27,-33,-76,37,25],[58,-75,83,60,84,75]]",
			args: args{[][]int{{-17, -2, 73, 44, 35, -70}, {98, -18, 22, -23, -91, -6}, {-70, -94, 24, 26, -79, 10}, {-31, -23, 56, -2, 77, 22}, {-7, 27, -33, -76, 37, 25}, {58, -75, 83, 60, 84, 75}}},
			want: -350,
		},
		{
			name: "38 / 49 ",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			//if got := minFallingPathSumBackTracking(tt.args.matrix); got != tt.want {
			//	t.Errorf("minFallingPathSum() = %v, want %v", got, tt.want)
			//}

			if got := minFallingPathSumDp(tt.args.matrix); got != tt.want {
				t.Errorf("minFallingPathSum() = %v, want %v", got, tt.want)
			}
		})
	}
